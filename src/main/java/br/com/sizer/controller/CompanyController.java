...
// @ApiResponse(responseCode = "200", description = "Retorna a empresa criada",
// content = @Content)
// @ApiResponse(responseCode = "403", description = "Você não tem permissão para
// criar uma empresa")
...
// @RequestMapping(value = "/companies", method = RequestMethod.GET, produces =
// { "application/json" })
// ResponseEntity<?> getAllCompany(@RequestParam(value = "page", defaultValue =
// "0") int page,
...
// // --------------------update the company --------------------
// @RequestMapping(value = "/company/{id}", method = RequestMethod.PUT, consumes
// = { "application/json" }, produces = {
// "application/json" })
// public ResponseEntity<?> updateCompany(@PathVariable(value = "id") Long
// companyId,
...
// public ResponseEntity<?> deleteCompany(@PathVariable(value = "id") Long
// companyId) {
...
// public ResponseEntity<?> search(@RequestParam(value = "search") String
// search) {
